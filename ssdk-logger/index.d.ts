...
interface IBaseLogger {
   ...
   * @memberof Logger
   */
  enterBlock(label: string | Buffer, channel?: string): boolean;
  /**
   ...
   * @memberof Logger
   */
  exitBlock(label: string | Buffer, channel?: string): boolean;
  /**
...
export interface Logger extends IBaseLogger {
  /**
  ...
  constructor(options?: {
    ...
    prefix?: string | Buffer;
    indent?: number;
    outStream?: Writable | Writable[];
  }): void;
}

export interface FileLogger extends IBaseLogger {
  /**
  ...
  constructor(
    ...
    options?: { level?: string; prefix?: string | Buffer; indent?: number },
  ): void;
}
